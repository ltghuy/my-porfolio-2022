...
const Sidebar: React.FC<SidebarProps> = ({ show, setShowFullMenu }) => {
  ...
  return (
    <div className="fixed h-screen w-20 top-0 left-0 z-40 bg-dark-200 border-r border-blur text-white text-center py-8 hidden md:flex flex-col flex-wrap justify-between overflow-hidden">
